 ...
 * 
 */
@WebServiceClient(name = "CalculatorServiceService", targetNamespace = "http://server.jws.oetting.de/", wsdlLocation = "http://localhost:8090/jws-server/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICESERVICE_QNAME = new QName("http://server.jws.oetting.de/", "CalculatorServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/jws-server/CalculatorService?wsdl");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://server.jws.oetting.de/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jws.oetting.de/", "CalculatorServicePort"), CalculatorService.class, features);
    }
