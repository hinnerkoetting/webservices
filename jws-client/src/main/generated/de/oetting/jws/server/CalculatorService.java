 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://server.jws.oetting.de/", wsdlLocation = "http://localhost:8080/jws-server/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://server.jws.oetting.de/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jws-server/CalculatorService?wsdl");
